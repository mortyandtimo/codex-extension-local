import{o as e}from"./rolldown-runtime-DAXXjFlN.js";import{t}from"./react-BUD3sqOU.js";import{t as n}from"./compiler-runtime-KOEWgTh7.js";import{Lu as r,Ru as i}from"./app-server-manager-signals-COqz12lX.js";import{H as a,Jn as o,Q as s,S as c,V as l,Xn as u,Yn as d,ar as f,cr as p,gr as m,hr as h,mr as g,pr as _}from"./src-VylWPNu6.js";import{S as v,r as y}from"./vscode-singleton.browser-BjAZ9ZUo.js";import{u as b}from"./path-8FI7ONm3.js";import{a as x,d as S,i as C,m as w,t as T}from"./app-scope-_o3s1Ui4.js";import{c as E}from"./vscode-api-C0hdEJtp.js";import{t as D}from"./useQuery-B7aNupSD.js";import{Ct as O,T as k,o as A,q as ee}from"./config-queries-DUP1-2DU.js";import{b as j,c as M}from"./thread-detail-level-DFryaulP.js";import{n as N}from"./use-host-config-Co3xREZz.js";import{l as P}from"./setting-storage-C0RhnnnT.js";import{i as F,n as te}from"./statsig-gate-signal-D9l66S1Q.js";import{lt as ne}from"./cloud-automation-state-C3GO9qq_.js";import{c as re}from"./statsig-BdYFwS32.js";import{o as ie,r as ae}from"./use-auth-C3cHiibs.js";import{r as oe,t as se}from"./browser-apps-account-BY3bOxOf.js";import{t as ce}from"./sortBy-BMWI4Oh-.js";import{n as le,t as I}from"./app-connect-actions-CoWWiTV2.js";import{t as ue}from"./use-codex-home-BSN07icd.js";import{t as de}from"./use-chatgpt-account-info-YycOZ6M9.js";import{t as L}from"./use-platform-B_cyI5oJ.js";import"./filesystem-media-src-DD1QY0Fm.js";import{a as R}from"./read-image-file-as-data-url-BcpP6Qsq.js";var z=n(),B=e(ce(),1),V={[le]:I},H=e(t(),1),U=w(T,({authMethod:e,hostId:t},{get:n})=>{let{data:r,isPending:i}=n(A,{authMethod:e,hostId:t});return{allowed:r!=null&&r.requirements?.allowBrowserAndComputerUse!==!1,isPending:i}});function W(e){let t=(0,z.c)(12),{hostId:n,featureName:r,defaultEnabled:i,enabled:a}=e,o=i===void 0||i,s=a===void 0||a,c;t[0]===s?c=t[1]:(c={enabled:s},t[0]=s,t[1]=c);let{data:l,isLoading:u}=C(j,n,c),d;t[2]===l?d=t[3]:(d=l===void 0?[]:l,t[2]=l,t[3]=d);let f=d,p;if(t[4]!==r||t[5]!==f){let e;t[7]===r?e=t[8]:(e=e=>e.name===r,t[7]=r,t[8]=e),p=f.find(e),t[4]=r,t[5]=f,t[6]=p}else p=t[6];let m=s&&(p?.enabled??o),h;return t[9]!==u||t[10]!==m?(h={enabled:m,isLoading:u},t[9]=u,t[10]=m,t[11]=h):h=t[11],h}function G(e){return e===`macOS`||e===`windows`}function fe(e){let t=(0,z.c)(24),{enabled:n,hostId:r}=e,i=n===void 0||n,{isLoading:a,platform:o}=L(),s=re(`1506311413`),c;t[0]!==i||t[1]!==r?(c={enabled:i,featureName:`computer_use`,hostId:r},t[0]=i,t[1]=r,t[2]=c):c=t[2];let l=W(c),u=ae(r),d=u?.authMethod??null,f;t[3]!==r||t[4]!==d?(f={authMethod:d,hostId:r},t[3]=r,t[4]=d,t[5]=f):f=t[5];let p;t[6]===i?p=t[7]:(p={enabled:i},t[6]=i,t[7]=p);let m=C(U,f,p),h=o===`windows`&&!a,g=i&&h,_;t[8]===g?_=t[9]:(_={enabled:g},t[8]=g,t[9]=_);let v=K(_),y=l.isLoading||h&&v.isLoading,b=l.enabled&&(!h||v.enabled),x=i&&(!!u?.isLoading||m.isPending),S=!i||m.allowed,w;t[10]!==b||t[11]!==i||t[12]!==y||t[13]!==s||t[14]!==a||t[15]!==o||t[16]!==x||t[17]!==S?(w=me({areRequirementsPending:x,areRequiredFeaturesEnabled:b,enabled:i,isBrowserAndComputerUseAllowed:S,isAnyFeatureLoading:y,isComputerUseGateEnabled:s,isHostCompatiblePlatform:G(o),isPlatformLoading:a,windowType:`chrome-extension`}),t[10]=b,t[11]=i,t[12]=y,t[13]=s,t[14]=a,t[15]=o,t[16]=x,t[17]=S,t[18]=w):w=t[18];let T=w,E=T===`available`,D=T===`loading`&&y,O=T===`loading`,k;return t[19]!==T||t[20]!==E||t[21]!==D||t[22]!==O?(k={available:E,isFetching:D,isLoading:O,reason:T},t[19]=T,t[20]=E,t[21]=D,t[22]=O,t[23]=k):k=t[23],k}function K(e){let t=(0,z.c)(21),{enabled:n}=e,r=(0,H.useContext)(ie)?.authMethod===`chatgpt`,i;t[0]===Symbol.for(`react.memo_cache_sentinel`)?(i=[`accounts`,`check`],t[0]=i):i=t[0];let a=n&&r,o;t[1]===a?o=t[2]:(o={queryKey:i,queryFn:pe,staleTime:E.ONE_MINUTE,enabled:a},t[1]=a,t[2]=o);let{data:s,errorUpdatedAt:c,isLoading:l}=D(o),u=s?.account_ordering?.[0],d;t[3]!==s?.accounts||t[4]!==u?(d=s?.accounts?.find(e=>e.id===u),t[3]=s?.accounts,t[4]=u,t[5]=d):d=t[5];let f=d,p=f==null&&(!l||c!==0),m=n&&r&&p,h;t[6]===m?h=t[7]:(h={enabled:m},t[6]=m,t[7]=h);let{data:g,isLoading:_}=de(h),y=f?.id??(p?g?.accountId:void 0),b=f?.plan_type??(p?g?.plan:void 0),x=r?b:void 0,S;t[8]===x?S=t[9]:(S=ne(x),t[8]=x,t[9]=S);let C=S,w;t[10]===y?w=t[11]:(w=[`accounts`,`settings`,y],t[10]=y,t[11]=w);let T=n&&y!=null&&C&&r,O;t[12]===y?O=t[13]:(O=async()=>v.safeGet(`/accounts/{account_id}/settings`,{parameters:{path:{account_id:y??``}}}),t[12]=y,t[13]=O);let k;t[14]!==T||t[15]!==O||t[16]!==w?(k={queryKey:w,enabled:T,queryFn:O,staleTime:E.ONE_MINUTE},t[14]=T,t[15]=O,t[16]=w,t[17]=k):k=t[17];let{data:A,isLoading:ee}=D(k),j=!r||b!=null&&(!C||(A?.beta_settings?.windows_computer_use??!1)),M=n&&r&&(l&&!p||_||ee),N;return t[18]!==j||t[19]!==M?(N={enabled:j,isLoading:M},t[18]=j,t[19]=M,t[20]=N):N=t[20],N}async function pe(){return v.safeGet(`/wham/accounts/check`)}function me({areRequirementsPending:e,areRequiredFeaturesEnabled:t,enabled:n,isBrowserAndComputerUseAllowed:r,isAnyFeatureLoading:i,isComputerUseGateEnabled:a,isHostCompatiblePlatform:o,isPlatformLoading:s,windowType:c}){return n?c===`electron`?e?`loading`:r?a?s?`loading`:o?i?`loading`:t?`available`:`config-requirement-disabled`:`unsupported-platform`:`statsig-disabled`:`config-requirement-disabled`:`window-type-disabled`:`disabled`}function he(e){let t=(0,z.c)(21),{enabled:n,hostId:r,windowType:i}=e,a=n===void 0||n,o=i===void 0?`chrome-extension`:i,s=re(`410065390`),l;t[0]!==a||t[1]!==r?(l={enabled:a,featureName:`browser_use_external`,hostId:r},t[0]=a,t[1]=r,t[2]=l):l=t[2];let u=W(l),d=ae(r),f=a||o===`chrome-extension`,p=d?.authMethod??null,m;t[3]!==r||t[4]!==p?(m={authMethod:p,hostId:r},t[3]=r,t[4]=p,t[5]=m):m=t[5];let h;t[6]===f?h=t[7]:(h={enabled:f},t[6]=f,t[7]=h);let g=C(U,m,h),_=P(c.runCodexInWsl),v=N(r),y=f&&(!!d?.isLoading||g.isPending),b=!f||g.allowed,x=_===!0||v.kind===`wsl`,S;t[8]!==u.enabled||t[9]!==u.isLoading||t[10]!==s||t[11]!==y||t[12]!==b||t[13]!==x||t[14]!==o?(S=ge({areRequirementsPending:y,isBrowserAndComputerUseAllowed:b,isExternalBrowserUseFeatureEnabled:u.enabled,isExternalBrowserUseFeatureLoading:u.isLoading,isExternalBrowserUseGateEnabled:s,runCodexInWsl:x,windowType:o}),t[8]=u.enabled,t[9]=u.isLoading,t[10]=s,t[11]=y,t[12]=b,t[13]=x,t[14]=o,t[15]=S):S=t[15];let w=S,T=w===`available`,E=w===`available`,D=w===`loading`,O;return t[16]!==w||t[17]!==T||t[18]!==E||t[19]!==D?(O={allowed:T,available:E,isLoading:D,reason:w},t[16]=w,t[17]=T,t[18]=E,t[19]=D,t[20]=O):O=t[20],O}function ge({areRequirementsPending:e,isBrowserAndComputerUseAllowed:t,isExternalBrowserUseFeatureEnabled:n,isExternalBrowserUseFeatureLoading:r,isExternalBrowserUseGateEnabled:i,runCodexInWsl:a,windowType:o}){return e?`loading`:t?o===`chrome-extension`?`available`:r?`loading`:i?n?a?`wsl-disabled`:`available`:`config-requirement-disabled`:`statsig-disabled`:`config-requirement-disabled`}function _e(e){let t=(0,z.c)(22),{enabled:n,hostId:r}=e,i=n===void 0||n,a;t[0]===Symbol.for(`react.memo_cache_sentinel`)?(a={name:`browser.in-app`},t[0]=a):a=t[0];let o=C(M,a).isCapable,s=re(`410262010`),l;t[1]!==i||t[2]!==r?(l={enabled:i,featureName:`browser_use`,hostId:r},t[1]=i,t[2]=r,t[3]=l):l=t[3];let u=W(l),d=ae(r),f=d?.authMethod??null,p;t[4]!==r||t[5]!==f?(p={authMethod:f,hostId:r},t[4]=r,t[5]=f,t[6]=p):p=t[6];let m;t[7]===i?m=t[8]:(m={enabled:i},t[7]=i,t[8]=m);let h=C(U,p,m),g=P(c.runCodexInWsl),_=N(r),v=u.enabled&&!u.isLoading,y=u.isLoading,b=i&&(!!d?.isLoading||h.isPending),x=!i||h.allowed,S=g===!0||_.kind===`wsl`,w;t[9]!==s||t[10]!==o||t[11]!==v||t[12]!==y||t[13]!==b||t[14]!==x||t[15]!==S?(w=ve({areRequirementsPending:b,isBrowserAgentGateEnabled:s,isBrowserAndComputerUseAllowed:x,isBrowserEnabled:o,isBrowserUseEnabled:v,isLoading:y,runCodexInWsl:S,windowType:`chrome-extension`}),t[9]=s,t[10]=o,t[11]=v,t[12]=y,t[13]=b,t[14]=x,t[15]=S,t[16]=w):w=t[16];let T=w,E=T===`available`,D=T===`available`,O=T===`loading`,k;return t[17]!==T||t[18]!==E||t[19]!==D||t[20]!==O?(k={allowed:E,available:D,isLoading:O,reason:T},t[17]=T,t[18]=E,t[19]=D,t[20]=O,t[21]=k):k=t[21],k}function ve({areRequirementsPending:e,isBrowserAgentGateEnabled:t,isBrowserAndComputerUseAllowed:n,isBrowserEnabled:r,isBrowserUseEnabled:i,isLoading:a,runCodexInWsl:o,windowType:s}){return s===`chrome-extension`?`window-type-disabled`:e?`loading`:n?a?`loading`:r?t?i?o?`wsl-disabled`:`available`:`config-requirement-disabled`:`statsig-disabled`:`browser-pane-disabled`:`config-requirement-disabled`}var ye=`plugins`;function be(e){let t=(0,z.c)(6),{enabled:n,hostId:r}=e,i=n===void 0||n,a;t[0]===i?a=t[1]:(a={enabled:i},t[0]=i,t[1]=a);let{data:o}=C(j,r,a),s;t[2]===o?s=t[3]:(s=o===void 0?[]:o,t[2]=o,t[3]=s);let c=s,l;return t[4]===c?l=t[5]:(l=c.find(q),t[4]=c,t[5]=l),i&&(l?.enabled??!0)}function q(e){return e.name===ye}function xe(e){let t=(0,z.c)(3),{computerUseAvailability:n,hostId:r}=e,{isLoading:i,platform:a}=L();re(`419294242`);let o;return t[0]!==!1||t[1]!==!1?(o={available:!1,isLoading:!1},t[0]=!1,t[1]=!1,t[2]=o):o=t[2],o}var J=`${p}@${_}`,Y=`com.apple.MobileSMS`,X={gmail:Z(`<svg xmlns="http://www.w3.org/2000/svg" width="192" height="192" fill="none" viewBox="0 0 192 192"><path fill="url(#gmail-2026-a)" d="M146 44h38v110c0 6.627-5.373 12-12 12h-20a6 6 0 0 1-6-6z"/><path fill="#fc413d" d="M46 44H8v110c0 6.627 5.373 12 12 12h20a6 6 0 0 0 6-6z"/><path fill="url(#gmail-2026-b)" d="M39.226 30.456c-8.033-6.752-20.018-5.714-26.77 2.319-6.752 8.032-5.714 20.017 2.319 26.77l76.078 63.949a8 8 0 0 0 10.295 0l76.078-63.95c8.032-6.752 9.07-18.737 2.318-26.77-6.752-8.032-18.737-9.07-26.769-2.318L96 78.18z"/><defs><linearGradient id="gmail-2026-a" x1="165" x2="165" y1="44" y2="166" gradientUnits="userSpaceOnUse"><stop stop-color="#60d673"/><stop offset=".17" stop-color="#42c868"/><stop offset=".39" stop-color="#0ebc5f"/><stop offset=".62" stop-color="#00a9bb"/><stop offset=".86" stop-color="#3c90ff"/><stop offset="1" stop-color="#3186ff"/></linearGradient><linearGradient id="gmail-2026-b" x1="8" x2="184" y1="46.13" y2="46.13" gradientUnits="userSpaceOnUse"><stop offset=".08" stop-color="#ff63a0"/><stop offset=".3" stop-color="#fc413d"/><stop offset=".5" stop-color="#fc413d"/><stop offset=".65" stop-color="#fc413d"/><stop offset=".72" stop-color="#fc5c30"/><stop offset=".86" stop-color="#feb10c"/><stop offset=".91" stop-color="#fec700"/><stop offset=".96" stop-color="#ffdb0f"/></linearGradient></defs></svg>`),"google-calendar":Z(`<svg xmlns="http://www.w3.org/2000/svg" width="192" height="192" viewBox="0 0 192 192" fill="none"><path fill="#bbe2ff" d="M32 36.8C32 20.894 44.894 8 60.8 8h70.4C147.106 8 160 20.894 160 36.8v30.4c0 15.906-12.894 28.8-28.8 28.8H60.8C44.894 96 32 83.106 32 67.2z"/><path fill="#3c90ff" d="M19.867 49.392C17.818 33.82 29.94 20 45.645 20h100.71c15.706 0 27.827 13.82 25.778 29.392L166 96l6.133 46.608C174.182 158.18 162.061 172 146.355 172H45.645c-15.706 0-27.827-13.82-25.778-29.392L26 96z"/><mask id="google-calendar-2026-a" width="154" height="152" x="19" y="20" maskUnits="userSpaceOnUse" style="mask-type:alpha"><path fill="#3c90ff" d="M19.867 49.392C17.818 33.82 29.94 20 45.645 20h100.71c15.706 0 27.827 13.82 25.778 29.392L166 96l6.133 46.608C174.182 158.18 162.061 172 146.355 172H45.645c-15.706 0-27.827-13.82-25.778-29.392L26 96z"/></mask><g mask="url(#google-calendar-2026-a)"><path fill="url(#google-calendar-2026-b)" d="M0 0h166v76H0z" transform="matrix(1 0 0 -1 13 172)"/></g><mask id="google-calendar-2026-c" width="154" height="152" x="19" y="20" maskUnits="userSpaceOnUse" style="mask-type:alpha"><path fill="#3186ff" d="M19.867 49.392C17.818 33.82 29.94 20 45.645 20h100.71c15.706 0 27.827 13.82 25.778 29.392L166 96l6.133 46.608C174.182 158.18 162.061 172 146.355 172H45.645c-15.706 0-27.827-13.82-25.778-29.392L26 96z"/></mask><g mask="url(#google-calendar-2026-c)"><path fill="url(#google-calendar-2026-d)" d="M32 27.2C32 16.596 40.596 8 51.2 8h89.6c10.604 0 19.2 8.596 19.2 19.2V96H32z" filter="url(#google-calendar-2026-e)"/></g><path fill="#fff" d="M75.353 133.336q-6.282 0-10.777-2.043t-7.61-5.465q-3.065-3.474-4.342-6.793T51.603 115a2.07 2.07 0 0 1 1.021-1.124l5.67-2.247q.714-.357 1.43-.102.714.204 1.685 2.349 1.022 2.145 2.86 4.546a14.3 14.3 0 0 0 4.495 3.728q2.606 1.328 6.435 1.328 6.18 0 9.807-3.575 3.677-3.575 3.677-9.091 0-5.976-3.882-9.194-3.881-3.269-10.266-3.269h-5.362a1.9 1.9 0 0 1-1.328-.51q-.51-.562-.511-1.277v-5.465q0-.767.51-1.277a1.82 1.82 0 0 1 1.329-.562h4.647q5.721 0 9.194-3.116t3.473-8.07q0-4.902-3.116-7.916t-8.58-3.014q-3.065 0-5.312 1.022a11.5 11.5 0 0 0-3.882 2.86 22.7 22.7 0 0 0-2.809 3.78q-1.174 1.941-1.89 2.145-.714.153-1.379-.255l-5.363-2.605q-.664-.358-.868-1.124t1.226-3.575q1.481-2.86 4.494-5.823a21 21 0 0 1 7.049-4.597q4.035-1.635 9.398-1.634 9.96 0 15.782 5.26 5.823 5.21 5.823 13.791 0 5.925-2.86 10.266-2.81 4.34-7.968 6.13v.204q6.231 1.838 9.806 6.741 3.627 4.853 3.626 11.594 0 9.654-6.742 15.834-6.74 6.18-17.57 6.18zm51.25-1.175q-.868 0-1.533-.664a2.25 2.25 0 0 1-.612-1.583V73.118l-11.492 8.274q-.614.46-1.431.307a1.96 1.96 0 0 1-1.225-.766l-3.32-4.7a1.98 1.98 0 0 1-.358-1.43q.153-.816.817-1.276l20.379-14.557q.256-.204.562-.306.307-.153.715-.153h4.291q.868 0 1.379.613.562.56.562 1.43v69.36q0 .92-.664 1.583a2 2 0 0 1-1.533.664z"/><defs><linearGradient id="google-calendar-2026-b" x1="83" x2="83" y1="76" gradientUnits="userSpaceOnUse"><stop stop-color="#4fa0ff"/><stop offset="1" stop-color="#3186ff"/></linearGradient><linearGradient id="google-calendar-2026-d" x1="89.06" x2="89.06" y1="21.75" y2="96.39" gradientUnits="userSpaceOnUse"><stop stop-color="#a9a8ff"/><stop offset=".8" stop-color="#3c90ff"/></linearGradient><filter id="google-calendar-2026-e" width="152" height="112" x="20" y="-4" color-interpolation-filters="sRGB" filterUnits="userSpaceOnUse"><feFlood flood-opacity="0" result="BackgroundImageFix"/><feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"/><feGaussianBlur result="effect1_foregroundBlur_37330_7673" stdDeviation="6"/></filter></defs></svg>`),"google-docs":Z(`<svg width="192" height="192" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`].map(e=>`data:image/svg+xml,${encodeURIComponent(e)}`);var Q=[`plugins`],Ee=4,De=new Set,Oe=[],ke=[],Ae=[],je=[],Me=[],$=[],Ne=[l],Pe=`computer-use`,Fe=`.tmp/marketplaces/openai-internal-testing`,Ie=[`datadog`,`statsig`],Le=new Set([`codex-official`,_,l,a,`openai-primary-runtime`].map(ft)),Re=S(T,({buildFlavor:e,hostId:t,isOpenAICuratedRemoteMarketplaceEnabled:n,marketplaceKinds:r,roots:i},{queryClient:a,scope:o})=>{let s=et({isOpenAICuratedRemoteMarketplaceEnabled:n}),c=Qe(t,i,r,n);return{queryKey:c,queryFn:async()=>{let n=await O(o,t).sendRequest(`plugin/list`,r==null?{...i.length>0?{cwds:i}:{},forceRefetch:De.has(t)||void 0}:{...i.length>0?{cwds:i}:{},marketplaceKinds:r,forceRefetch:De.has(t)||void 0}),l=tt(n.marketplaces,s),u=bt(l,a.getQueryData(c)?.plugins),d=e==null?u:dt({buildFlavor:e,plugins:u}),p=He(n.featuredPluginIds).filter(e=>!s.some(t=>e.endsWith(`@${t}`))),h=e==null?p:ut({buildFlavor:e,featuredPluginIds:p});return{bundledCodexAppToolsPlugin:l.find(({name:e})=>m(e))?.plugins.find(({name:e})=>e===f),featuredPluginIds:h,marketplaceLoadErrors:n.marketplaceLoadErrors,marketplaces:mt(l),plugins:await ht({hostId:t,plugins:d,queryClient:a})}},staleTime:E.SIX_HOURS,gcTime:E.FIVE_MINUTES}});S(T,({hostId:e,marketplaceKind:t},{queryClient:n,scope:r})=>{let i=[...Q,`marketplace-kind`,e,t];return{queryKey:i,queryFn:async()=>ht({hostId:e,plugins:bt((await O(r,e).sendRequest(`plugin/list`,{marketplaceKinds:[t],forceRefetch:De.has(e)||void 0})).marketplaces,n.getQueryData(i)),queryClient:n}),staleTime:E.SIX_HOURS}});function ze(e){return{...xt(e.summary),description:e.summary.interface?.shortDescription??e.description??null,displayName:e.summary.interface?.displayName??null,marketplaceDisplayName:null,marketplaceName:e.marketplaceName,plugin:e.summary,keywords:e.summary.keywords,...Ke({marketplaceName:e.marketplaceName,marketplacePath:e.marketplacePath})}}function Be({marketplacePath:e,remoteMarketplaceName:t}){if(e!=null&&t!=null)throw Error(`plugin marketplace request requires one marketplace source`);if(e!=null)return{marketplacePath:e};if(t!=null)return{remoteMarketplaceName:t};throw Error(`plugin marketplace request requires a marketplace source`)}function Ve(e){return e.marketplacePath??`remote:${e.remoteMarketplaceName}`}function He(e){return e.filter(e=>{let t=lt(e).toLowerCase();return!Ie.some(e=>t===e||t.startsWith(`${e}-`))})}function Ue(e){return e.marketplacePath==null?We(e.plugin):e.plugin.name}function We(e){if(e.remotePluginId==null)throw Error(`remote plugin ${e.id} is missing remotePluginId`);return e.remotePluginId}function Ge(e){return{...Be(e),pluginName:Ue(e)}}function Ke({marketplaceName:e,marketplacePath:t}){return t==null?{marketplacePath:null,remoteMarketplaceName:e}:{marketplacePath:t,remoteMarketplaceName:null}}function qe(e,t,n){let i=(0,z.c)(79),a=n?.enabled!==!1,o;i[0]!==e||i[1]!==a?(o={enabled:a,hostId:e},i[0]=e,i[1]=a,i[2]=o):o=i[2];let s=be(o)&&a,c=n?.additionalMarketplaceKinds??Ae,l=re(`4218407052`),u=ae(e),d=n?.includeRemoteCatalog??!0,f;i[3]!==c||i[4]!==u?.authMethod||i[5]!==l||i[6]!==n?.includeRemoteCatalog||i[7]!==d?(f=Ze({additionalMarketplaceKinds:c,includeRemoteCatalog:d,includeVerticalCatalog:n?.includeRemoteCatalog!==!1&&!l&&Te(u?.authMethod??null)}),i[3]=c,i[4]=u?.authMethod,i[5]=l,i[6]=n?.includeRemoteCatalog,i[7]=d,i[8]=f):f=i[8];let p=f,m=ee(),h=x(r),g;i[9]!==e||i[10]!==h?(g=h.includes(e),i[9]=e,i[10]=h,i[11]=g):g=i[11];let _=g,v=t===void 0,y;i[12]===e?y=i[13]:(y={hostId:e},i[12]=e,i[13]=y);let b=s&&_&&v,S;i[14]===b?S=i[15]:(S={enabled:b},i[14]=b,i[15]=S);let w=C(k,y,S),T;i[16]===s?T=i[17]:(T={enabled:s},i[16]=s,i[17]=T);let E=ue(e,T),D=s&&_,O;i[18]!==e||i[19]!==D?(O={enabled:D,hostId:e},i[18]=e,i[19]=D,i[20]=O):O=i[20];let A=fe(O),j;i[21]!==A||i[22]!==e?(j={computerUseAvailability:A,hostId:e},i[21]=A,i[22]=e,i[23]=j):j=i[23];let M=xe(j),N=s&&_,P;i[24]!==e||i[25]!==N?(P={enabled:N,hostId:e},i[24]=e,i[25]=N,i[26]=P):P=i[26];let F=_e(P),te=s&&_,ne;i[27]!==e||i[28]!==te?(ne={enabled:te,hostId:e},i[27]=e,i[28]=te,i[29]=ne):ne=i[29];let ie=he(ne),oe=w.data?.roots,se;i[30]!==E||i[31]!==e||i[32]!==t||i[33]!==oe?(se=_t({codexHome:E,hostId:e,rootsOverrideCwd:t,workspaceRoots:oe}),i[30]=E,i[31]=e,i[32]=t,i[33]=oe,i[34]=se):se=i[34];let ce=se,le=s&&u?.isLoading!==!0&&_&&(t!==void 0||w.isFetched),I;i[35]===Symbol.for(`react.memo_cache_sentinel`)?(I=`prod`,i[35]=I):I=i[35];let de=I,L;i[36]!==e||i[37]!==l||i[38]!==p||i[39]!==ce?(L={buildFlavor:de,hostId:e,isOpenAICuratedRemoteMarketplaceEnabled:l,marketplaceKinds:p,roots:ce},i[36]=e,i[37]=l,i[38]=p,i[39]=ce,i[40]=L):L=i[40];let R;i[41]===le?R=i[42]:(R={enabled:le},i[41]=le,i[42]=R);let B=C(Re,L,R);if(!s||!_){let e;return i[43]===Symbol.for(`react.memo_cache_sentinel`)?(e={availablePlugins:$,featuredPluginIds:Oe,installedPlugins:$,marketplaceLoadErrors:ke,marketplaces:Me,errorMessage:null,isLoading:!1,isFetching:!1,refetch:Xe,reload:Ye,forceReload:Je},i[43]=e):e=i[43],e}let V,H,U,W,G;i[44]!==A.available||i[45]!==ie.available||i[46]!==F.available||i[47]!==M.available||i[48]!==B.data?.bundledCodexAppToolsPlugin||i[49]!==B.data?.featuredPluginIds||i[50]!==B.data?.plugins?(V={isComputerUseAvailable:A.available,isExternalBrowserUseAvailable:ie.available,isInAppBrowserUseAvailable:F.available,isMessagesAvailable:M.available},H=B.data?.plugins??$,U=rt({plugins:H,...V}),W=B.data?.bundledCodexAppToolsPlugin,G=nt({featuredPluginIds:B.data?.featuredPluginIds??Oe,...V}),i[44]=A.available,i[45]=ie.available,i[46]=F.available,i[47]=M.available,i[48]=B.data?.bundledCodexAppToolsPlugin,i[49]=B.data?.featuredPluginIds,i[50]=B.data?.plugins,i[51]=V,i[52]=H,i[53]=U,i[54]=W,i[55]=G):(V=i[51],H=i[52],U=i[53],W=i[54],G=i[55]);let K;i[56]===H?K=i[57]:(K=it(H),i[56]=H,i[57]=K);let pe=B.data?.marketplaceLoadErrors??ke,me=B.data?.marketplaces??Me,ge=B.error?B.error.message:null,ve=v&&w.isLoading||B.isLoading||F.isLoading||ie.isLoading||A.isLoading||M.isLoading,ye=v&&w.isFetching||B.isFetching||A.isFetching,q;i[58]!==V||i[59]!==B?(q=async()=>{let e=(await B.refetch()).data?.plugins??$;return{availablePlugins:rt({plugins:e,...V}),installedPlugins:it(e)}},i[58]=V,i[59]=B,i[60]=q):q=i[60];let J;i[61]===m?J=i[62]:(J=()=>m(Q),i[61]=m,i[62]=J);let Y;i[63]!==e||i[64]!==m?(Y=async()=>{De.add(e),await(async()=>{await m(Q)})().finally(()=>{De.delete(e)})},i[63]=e,i[64]=m,i[65]=Y):Y=i[65];let X;return i[66]!==U||i[67]!==W||i[68]!==G||i[69]!==K||i[70]!==pe||i[71]!==me||i[72]!==ge||i[73]!==ve||i[74]!==ye||i[75]!==q||i[76]!==J||i[77]!==Y?(X={availablePlugins:U,bundledCodexAppToolsPlugin:W,featuredPluginIds:G,installedPlugins:K,marketplaceLoadErrors:pe,marketplaces:me,errorMessage:ge,isLoading:ve,isFetching:ye,refetch:q,reload:J,forceReload:Y},i[66]=U,i[67]=W,i[68]=G,i[69]=K,i[70]=pe,i[71]=me,i[72]=ge,i[73]=ve,i[74]=ye,i[75]=q,i[76]=J,i[77]=Y,i[78]=X):X=i[78],X}async function Je(){}async function Ye(){}async function Xe(){return{availablePlugins:$,installedPlugins:$}}function Ze({additionalMarketplaceKinds:e,includeRemoteCatalog:t,includeVerticalCatalog:n}){return t&&!n&&e.length===0?null:n?[`local`,`vertical`,...e]:[`local`,...e]}function Qe(e,t,n,r){let i=$e(r);return n==null?[...Q,e,t,`curated-marketplace`,i]:[...Q,e,t,`marketplace-kinds`,n,`curated-marketplace`,i]}function $e(e){return e?a:l}function et({isOpenAICuratedRemoteMarketplaceEnabled:e}){return e?Ne:je}function tt(e,t){return t.length===0?e:e.filter(e=>!t.includes(e.name))}function nt({featuredPluginIds:e,...t}){return e.filter(e=>at(e,t))}function rt({plugins:e,...t}){return e.filter(e=>at(e.plugin.id,t))}function it(e){return e.filter(e=>e.plugin.installed)}function at(e,{isComputerUseAvailable:t,isExternalBrowserUseAvailable:n,isInAppBrowserUseAvailable:r,isMessagesAvailable:i}){return lt(e)===`browser`?r||n:!(!r&&ot(e)||!n&&st(e)||!t&&ct(e)||!i&&e===J)}function ot(e){let t=lt(e);return t===`browser`||t===`browser-use`}function st(e){let t=lt(e);return t===`chrome`||t===`chrome-dev`||t===`chrome-internal`}function ct(e){return lt(e)===Pe}function lt(e){let t=e.indexOf(`@`);return t===-1?e:e.slice(0,t)}function ut({buildFlavor:e,featuredPluginIds:t}){let n=g(e);return t.filter(e=>{let t=s(e);return t==null||!m(t)||t===n})}function dt({buildFlavor:e,plugins:t}){let n=g(e);return t.filter(e=>!m(e.marketplaceName)||e.marketplaceName===n)}function ft(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)}function pt(e){return Le.has(ft(e))}function mt(e){let t=new Map;for(let n of e){let e=`${n.name}\u0000${n.path??``}`;if(t.has(e))continue;let r=pt(n.name);t.set(e,{displayName:n.interface?.displayName??null,isBuiltIn:r,name:n.name,path:n.path,pluginCount:n.plugins.length})}return Array.from(t.values()).sort((e,t)=>{let n=e.displayName?.trim()||e.name,r=t.displayName?.trim()||t.name;return n.localeCompare(r)})}async function ht({hostId:e,plugins:t,queryClient:n,signal:r}){let i=[...t];async function a(o){let s=t[o];if(s==null)return;let[c,l,u]=await Promise.all([gt(s.composerIconPath,e,n,r),gt(s.logoPath,e,n,r),gt(s.logoDarkPath,e,n,r)]);(c!=null||l!=null||u!=null)&&(i[o]={...s,composerIconPath:c??s.composerIconPath,logoDarkPath:u??s.logoDarkPath,logoPath:l??s.logoPath,plugin:s.plugin.interface?{...s.plugin,interface:{...s.plugin.interface,composerIcon:c??s.plugin.interface.composerIcon,logo:l??s.plugin.interface.logo,...u==null?{}:{logoDark:u}}}:s.plugin}),await a(o+Ee)}return await Promise.all(Array.from({length:Math.min(Ee,t.length)},(e,t)=>a(t))),i}async function gt(e,t,n,r){return R(e,t,n,r)}function _t({codexHome:e,hostId:t,rootsOverrideCwd:n,workspaceRoots:r}){let i=t===`local`&&e!=null?b(e,Fe):null;return vt([...typeof n==`string`?[n]:n??r??[],...i==null?[]:[i]],e)}function vt(e,t){return Array.from(new Set(e.map(e=>e.trim()).filter(e=>o(e)&&yt(e,t))))}function yt(e,t){return t==null?!0:d(t)||u(t)?d(e)||u(e):e.startsWith(`/`)&&!e.startsWith(`//`)}function bt(e,t=$){let n=new Map,r=new Set;for(let t of e)for(let e of t.plugins){if(h(e.name,s(e.id)??t.name))continue;e.installed||r.add(e.id);let i={...xt(e),description:e.interface?.shortDescription??null,displayName:e.interface?.displayName??null,marketplaceDisplayName:t.interface?.displayName??null,marketplaceName:t.name,plugin:e,keywords:e.keywords,...Ke({marketplaceName:t.name,marketplacePath:t.path})},a=n.get(e.id);if(a==null){n.set(e.id,i);continue}let o=a;(a.plugin.installed&&!e.installed||a.plugin.installed===e.installed&&a.plugin.interface==null&&e.interface!=null)&&(o=i),a.plugin.installed&&!e.installed&&n.delete(e.id);let c=null;if(a.plugin.installed?c=a.plugin:e.installed&&(c=e),c==null){n.set(e.id,o);continue}n.set(e.id,{...o,plugin:{...o.plugin,enabled:c.enabled,installed:!0,installPolicy:c.installPolicy,localVersion:c.localVersion,remotePluginId:o.plugin.remotePluginId??c.remotePluginId}})}let i=new Map(t.map(e=>[e.plugin.id,e])),a=!1,o=Array.from(n.values()).map(e=>{let t=i.get(e.plugin.id);return!e.plugin.installed||t==null||r.has(e.plugin.id)?e:(a||=e.marketplaceName!==t.marketplaceName||e.marketplacePath!==t.marketplacePath,{...t,plugin:{...e.plugin,id:t.plugin.id,interface:t.plugin.interface??e.plugin.interface,keywords:t.plugin.keywords??e.plugin.keywords,name:t.plugin.name,remotePluginId:t.plugin.remotePluginId??e.plugin.remotePluginId,shareContext:t.plugin.shareContext??e.plugin.shareContext,source:t.plugin.source}})});if(!a)return o;let c=new Map(o.map(e=>[e.plugin.id,e]));return[...t.flatMap(e=>{let t=c.get(e.plugin.id);return c.delete(e.plugin.id),t==null?[]:[t]}),...c.values()]}function xt(e,t){let n=e.interface,r=n?.composerIcon??n?.composerIconUrl,i=n?.logo??n?.logoUrl,a=n?.logoDark??n?.logoUrlDark,o=Se(e),s=i!=null||a!=null,c=r??(s?null:o),l=s?i??a??null:o??t?.logoUrl??t?.logoUrlDark??null;return{composerIconPath:c,logoDarkPath:s?a??null:o??t?.logoUrlDark??t?.logoUrl??null,logoPath:l}}var St=3e4;function Ct(e){return AbortSignal.any([e,AbortSignal.timeout(St)])}var wt=w(T,(e,{get:t})=>{let{data:n}=t(j,e);if(n==null)return;let r=n.find(e=>e.name===`remote_plugin`);if(r!=null)return r.enabled;if(!t(F,`4218407052`))return t(te,`4218407052`)}),Tt=S(T,({accountId:e,hostId:t,roots:n},{get:r,queryClient:a,scope:o})=>{let s=kt(t),c=s?!0:r(wt,t);return{enabled:s?e!=null:n!=null&&(t===`local`||r(i,t)===`connected`),queryKey:s?[...Q,`installed`,t,`hosted`,e]:[...Q,`installed`,t,n],queryFn:async({signal:e})=>{if(s)return(await Dt({productContext:`codex`,signal:e})).map(Ot);let{marketplaces:r}=await O(o,t).sendRequest(`plugin/installed`,n!=null&&n.length>0?{cwds:n}:{},{priority:`background`,timeoutMs:St});return ht({hostId:t,plugins:bt(r),queryClient:a,signal:Ct(e)})},select:e=>(0,B.default)(c?e.filter(({marketplaceName:e})=>e!==l):e,({plugin:e})=>-(e.installedAt??0)),retry:!1,staleTime:E.ONE_MINUTE}});function Et(e){let t=(0,z.c)(18),{enabled:n,hostId:r,roots:i,resolveActiveRoots:a}=e,o=n===void 0||n,s=a!==void 0&&a,c;t[0]===r?c=t[1]:(c=kt(r),t[0]=r,t[1]=c);let l=c,u=ae(l?y:r);x(se);let d=x(oe),f;t[2]===r?f=t[3]:(f={hostId:r},t[2]=r,t[3]=f);let p=o&&!l&&s&&i==null,m;t[4]===p?m=t[5]:(m={enabled:p},t[4]=p,t[5]=m);let{data:h}=C(k,f,m),g=s?i??h?.roots:i,_=l?d:null,v;t[6]!==r||t[7]!==g||t[8]!==_?(v={accountId:_,hostId:r,roots:g},t[6]=r,t[7]=g,t[8]=_,t[9]=v):v=t[9];let b=o&&(l||u?.isLoading!==!0),S;t[10]===b?S=t[11]:(S={enabled:b},t[10]=b,t[11]=S);let w=C(Tt,v,S),T,E;t[12]===w?(T=t[13],E=t[14]):({isLoading:E,...T}=w,t[12]=w,t[13]=T,t[14]=E);let D=o&&(E||!l&&(u?.isLoading===!0||g==null)),O;return t[15]!==T||t[16]!==D?(O={...T,isLoading:D},t[15]=T,t[16]=D,t[17]=O):O=t[17],O}async function Dt({productContext:e,signal:t}){let n=[],r;do{let i=await v.safeGet(`/ps/plugins/installed`,{parameters:{query:r==null?{}:{pageToken:r}},additionalHeaders:e===`codex`?V:void 0,signal:t==null?void 0:Ct(t)});n.push(...i.plugins),r=i.pagination.next_page_token??void 0}while(r!=null);return n}function Ot(e){let t=e.release.interface,n=`enabled`in e,r=e.release.keywords??t.capabilities;return{canonicalAppId:e.canonical_app_id??null,description:t.short_description??e.release.description,displayName:e.release.display_name,logoDarkPath:t.logo_url_dark??null,logoPath:t.logo_url,marketplaceDisplayName:null,marketplaceName:a,marketplacePath:null,remoteMarketplaceName:a,keywords:r,requiresLocalExecutor:e.release.requires_local_executor===!0,plugin:{authPolicy:e.authentication_policy??`ON_USE`,installedAt:null,disabledReason:e.disabled_reason??(e.status===`DISABLED_BY_ADMIN`?`disabled_by_admin`:null),eligiblePlanTypes:e.eligible_plan_types??null,availability:e.status===`DISABLED_BY_ADMIN`?`DISABLED_BY_ADMIN`:`AVAILABLE`,enabled:n&&e.enabled,id:`${e.name}@${a}`,installed:n,installPolicy:e.installation_policy??`AVAILABLE`,installPolicySource:e.installation_policy_source??null,interface:{brandColor:t.brand_color??null,capabilities:t.capabilities,category:t.category,composerIcon:null,composerIconUrl:t.composer_icon_url??null,defaultPrompt:t.default_prompts??(t.default_prompt==null?null:[t.default_prompt]),developerName:t.developer_name??null,displayName:e.release.display_name,logo:null,logoDark:null,logoUrl:t.logo_url,logoUrlDark:t.logo_url_dark??null,longDescription:t.long_description??null,privacyPolicyUrl:t.privacy_policy_url??null,screenshots:[],screenshotUrls:t.screenshot_urls??[],shortDescription:t.short_description,termsOfServiceUrl:t.terms_of_service_url??null,websiteUrl:t.website_url??null},keywords:r,localVersion:null,mustShowInstallationInterstitial:e.must_show_installation_interstitial??null,name:e.name,remotePluginId:e.id,shareContext:null,source:{type:`remote`},version:e.release.version??null}}}function kt(e){return!1}export{fe as C,he as S,J as _,Et as a,be as b,rt as c,Ve as d,Be as f,qe as g,ct as h,kt as i,bt as l,Ue as m,Dt as n,Q as o,Ge as p,Tt as r,ze as s,Ot as t,xt as u,Y as v,V as w,_e as x,xe as y};