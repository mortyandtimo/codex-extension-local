import{n as e}from"./src-DMUluKFh.js";import{t}from"./ordinal-hYBb2elL.js";import{t as n}from"./arc-DR9td1q0.js";import{t as r}from"./pie-DMuufHLU.js";import{i,p as a}from"./chunk-ICXQ74PX-BVFOcIxo.js";import{n as o}from"./chunk-Y2CYZVJY-DsF7k-Jl.js";import{H as s,K as c,U as l,a as u,c as d,f,v as p,w as m,x as h,y as g}from"./chunk-WYO6CB5R-CsecU0l8.js";import{t as _}from"./chunk-VAUOI2AC-BptFiTI0.js";import{t as v}from"./chunk-JWPE2WC7-DVXcaiue.js";import{n as y}from"./mermaid-parser.core-ygm3cZ_w.js";var b=f.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:o(()=>structuredClone(w),`getConfig`),clear:o(()=>{S=new Map,C=x.showData,u()},`clear`),setDiagramTitle:c,getDiagramTitle:m,setAccTitle:l,getAccTitle:g,setAccDescription:s,getAccDescription:p,addSection:o(({label:t,value:n})=>{if(n<0)throw Error(`"${t}" has invalid value: ${n}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(t)||(S.set(t,n),e.debug(`added new section: ${t}, with value: ${n}`))},`addSection`),getSections:o(()=>S,`getSections`),setShowData:o(e=>{C=e},`setShowData`),getShowData:o(()=>C,`getShowData`)},E=o((e,t)=>{v(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:o(async t=>{let n=await y(`pie`,t);e.debug(n),E(n,T)},`parse`)},O=o(e=>`
  .pieCircle{
